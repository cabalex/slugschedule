...
<main bind:this={mainElem} class:focused={$focusedClass} class:scheduler={$listMode === "scheduler"}>
    ...
    {:else}
        ...
        <p>Created with 💛 by <a href="https://cabalex.github.io">@cabalex</a> and <a href="https://github.com/darthnithin">@darthnithin</a>. <a href="https://github.com/cabalex/slugschedule" target="_blank" rel="noopener noreferrer">View source here</a>.</p>
